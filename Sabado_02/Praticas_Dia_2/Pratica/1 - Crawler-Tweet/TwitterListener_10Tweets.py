...
def coletar_tweets():
    ...
    access_token = "742142292820152324-cBU4iTuvVOPmDzwcpcW0IlcFIg0vEGY"
    #Complete aqui com o valor da "access_token_secret" gerada para você
    access_token_secret = "4jR1LL10BkNnpjVVEbUABgSGP6nuXnNHb9fspSpDSMCXy"
    #Complete aqui com o valor da "consumer_key" gerada para você
    consumer_key = "pTl0ETFlM3DAjMK2wSt9sAAos"
    #Complete aqui com o valor da "consumer_secret" gerada para você
    consumer_secret = "QP8wBiigIfxy0PTCvvpWcUErVK84BejYa4GKlwnOPxgTzFcVsD"
    ...
    stream.filter(track=['Silvio Santos', 'Fantástico', 'Rebeca', 'Flamengo', 'Palmeiras'])
