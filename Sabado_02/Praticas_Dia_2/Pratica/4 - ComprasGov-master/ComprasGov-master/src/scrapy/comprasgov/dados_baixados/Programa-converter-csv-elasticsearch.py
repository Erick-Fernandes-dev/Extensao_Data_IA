...
if __name__ == '__main__':
    ...
    parser.add_argument('--elastic-endereco',
                        required=False,
                        type=str,
                        default='10.89.5.153:9200',
                        help='Servidor elasticsearch endpoint Endereço')
    ...
    parser.add_argument('--password',
                        ...
                        type=str,
                        help='Password')
    parser.add_argument('--csv-file fornecedores.ambito_ocorrencia.json',
                        required=True,
                        type=str,
                        help='C:\\RicardoRoberto\\Projeto-BigData-Acordaos-TCU\\ComprasGov-master\\ComprasGov-master\\src\\scrapy')
    parser.add_argument('--json-struct' {
                        ...
                        required=True,
                        type=str,
                        help='fornecedores.ambito_ocorrencia.json')
    parser.add_argument('--elastic-index ELASTIC_INDEX',
                        required=True,
                        type=str,
