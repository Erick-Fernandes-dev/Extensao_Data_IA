...
if __name__ == '__main__':
    ...
    csv_file = 'comprasemlicitacao.itens_compras.csv'
    ...
    """
    json_structure = '{"id" : "%id%", "ds_fundamento_legal" : "%ds_fundamento_legal%", "ds_justificativa" : "%ds_justificativa%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'comprasemlicitacao_itens_compras'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"id" : "%id%", "ds_fundamento_legal" : "%ds_fundamento_legal%", "ds_justificativa" : "%ds_justificativa%"}',
