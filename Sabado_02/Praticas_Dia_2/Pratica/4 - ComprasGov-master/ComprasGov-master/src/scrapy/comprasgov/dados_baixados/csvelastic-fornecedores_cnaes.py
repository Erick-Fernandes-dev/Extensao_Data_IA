...
if __name__ == '__main__':
    ...
    csv_file = 'fornecedores.cnaes.csv'
    ...
    """
    json_structure = '{"descricao" : "%descricao%", "codigo_longo" : "%codigo_longo%", "offset" : "%offset%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'fornecedores_cnaes'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"descricao" : "%descricao%", "codigo_longo" : "%codigo_longo%", "offset" : "%offset%"}',
