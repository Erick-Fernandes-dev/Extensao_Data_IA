...
if __name__ == '__main__':
    ...
    csv_file = 'Municipios_Brasileiros.csv'
    ...
    """
    json_structure = '{"codigoibge" : "%codigoibge%", "nomedomunicipio" : "%nomedomunicipio%", "uf" : "%uf%", "estado" : "%estado%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'fornecedores_municipios'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"codigoibge" : "%codigoibge%", "nomedomunicipio" : "%nomedomunicipio%", "uf" : "%uf%", "estado" : "%estado%"}',
