...
if __name__ == '__main__':
    ...
    csv_file = 'fornecedores.naturezas_juridicas.csv'
    ...
    json_structure = '{"descricao" : "%descricao", "offset" : "%offset%"}'
    """
    json_structure = '{"id" : "%id%", "descricao" : "%descricao%", "ativo" : "%ativo%", "offset" : "%offset%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'fornecedores_natureza_juridica'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"descricao" : "%descricao%", "offset" : "%offset%"}',
