...
if __name__ == '__main__':
    ...
    csv_file = 'fornecedores.prazos_ocorrencia.csv'
    ...
    """
    json_structure = '{"id" : "%id%", "descricao" : "%descricao%", "offset" : "%offset%", "item_filename" : "%item_filename%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'fornecedores_prazos_ocorrencia'

    # 5) Delimitador do CSV. Por padrão usamos TAB, então /t outro delimitador nesse caso é vírgula..
    delimiter = '\t'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"id" : "%id%", "descricao" : "%descricao%", "offset" : "%offset%", "item_filename" : "%item_filename%"}',
