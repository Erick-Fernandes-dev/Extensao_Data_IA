...
if __name__ == '__main__':
    ...
    csv_file = 'fornecedores.tipos_ocorrencia.csv'
    ...
    """
    json_structure = '{"id" : "%id%", "descricao" : "%descricao%", "offset" : "%offset%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'fornecedores_tipos_ocorrencia'
