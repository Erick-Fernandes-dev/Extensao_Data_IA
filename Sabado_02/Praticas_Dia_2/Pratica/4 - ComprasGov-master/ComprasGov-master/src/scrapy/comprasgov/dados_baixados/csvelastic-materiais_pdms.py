...
if __name__ == '__main__':
    ...
    """
    json_structure = '{"codigo" : "%codigo%", "descricao" : "%descricao%", "offset" : "%offset%", "item_filename" : "%item_filename%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'materiais_pdms1'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"codigo" : "%codigo%", "descricao" : "%descricao%", "offset" : "%offset%", "item_filename" : "%item_filename%"}',
