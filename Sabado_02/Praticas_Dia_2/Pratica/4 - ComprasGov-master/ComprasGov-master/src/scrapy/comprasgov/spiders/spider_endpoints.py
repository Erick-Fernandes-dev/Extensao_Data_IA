...
class Endpoints(scrapy.Spider):
    ...
    custom_settings = {
        "ITEM_PIPELINES" : {
            'comprasgov.pipelines.CSVEndpointsPipeline': 300,
        }
    }
    ...
    def parse_methods_json(self, response):
        ...
        for path in paths:
            ...
            if "resourcePath" in content:
                ...
                url = "https://dadosabertos.compras.gov.br/" + response.meta["module_path"] + path + ".json"
    ...
    def parse_methods_html(self, response):
        ...
        for item in table:
            ...
            url = "https://dadosabertos.compras.gov.br/" + path.replace(".html", ".json")
