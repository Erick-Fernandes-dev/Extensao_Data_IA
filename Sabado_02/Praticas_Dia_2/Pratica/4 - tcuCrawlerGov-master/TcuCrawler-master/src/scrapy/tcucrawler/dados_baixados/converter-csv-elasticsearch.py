...
if __name__ == '__main__':
    ...
    parser.add_argument('--password',
                        ...
                        type=str,
                        help='Password')
    parser.add_argument('--csv-file fornecedores.ambitos_ocorrencia.csv',
                        required=True,
                        type=str,
                        help='path to csv to import')
    parser.add_argument('--json-struct {"descricao" : "%descricao%", "offset" : "%offset%", "item_filename" : "%item_filename%"}',
                        required=True,
                        type=str,
