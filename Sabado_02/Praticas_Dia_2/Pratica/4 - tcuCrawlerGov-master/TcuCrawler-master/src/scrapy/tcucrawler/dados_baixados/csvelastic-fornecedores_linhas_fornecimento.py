...
if __name__ == '__main__':
    ...
    csv_file = 'fornecedores.linhas_fornecimento.csv'
    ...
    """
    json_structure = '{"codigo_material" : "%codigo_material%", "tipo" : "%tipo%", "offset" : "%offset%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'fornecedores_linhas_fornecimento'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"codigo_material" : "%codigo_material%", "tipo" : "%tipo%", "offset" : "%offset%"}',
