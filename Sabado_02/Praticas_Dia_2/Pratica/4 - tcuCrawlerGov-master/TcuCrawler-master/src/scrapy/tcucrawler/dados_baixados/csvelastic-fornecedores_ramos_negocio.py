...
if __name__ == '__main__':
    ...
    csv_file = 'fornecedores.ramos_negocio.csv'
    ...
    """
    json_structure = '{"id" : "%id%", "descricao" : "%descricao%", "offset" : "%offset%", "ativo" : "%ativo%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'fornecedores_ramos_negocio'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"id" : "%id%", "descricao" : "%descricao%", "offset" : "%offset%", "ativo" : "%ativo%"}',
