...
if __name__ == '__main__':
    ...
    """
    json_structure = '{"codigo" : "%codigo%", "descricao" : "%descricao%", "codigo_grupo" : "%codigo_grupo%", "offset" : "%offset%"}'

    # 4) Local onde deve ser salvo as informações (INDEX)
    elastic_index = 'servicos_classes'
    ...
    parser.add_argument('--json-struct',
                        required=False,
                        type=str,
                        default='{"codigo" : "%codigo%", "descricao" : "%descricao%", "codigo_grupo" : "%codigo_grupo%", "offset" : "%offset%"}',
